...
const BookopenSlider = () => {
  ...
  return (
    <section className="w-full mt-[280%] sm:mt-[50%] lg:mt-[60%] mb-20 xl:mt-[70%] 2xl:mt-[60%] 3xl:mt-[20%] ">
      <div className="w-full flex   flex-col sm:flex-row lg:flex-row  justify-between px-2 sm:px-10 lg:px-24 ">
        <div className="w-full  flex flex-col gap-4">
          <h2 className="text-[#2E234B] text-5xl custom-font text-center  lg:text-4xl  xl:text-4xl  2xl:text-5xl  3xl:text-7xl ">
            Celebrating Your Success
          </h2>
          <p className=" text-center  text-[#2E234B] px-0 md:px-60 addregfont lg:text-xs xl:text-sm 2xl:text-lg 3xl:text-2xl ">
        ...
        <div className="w-full relative z-10">
          <Slider ref={sliderRef} {...settings}>
            {books.map((book, index) => (
              ...
              >
                <div className="relative p-4 h-[35vh] md:h-[35vh] xl:h-[65vh] lg:h-[45vh] md:mt-10 lg:mt-4 xl:mt-12 2xl:mt-24 3xl:mt-44">
                  <img
                    src={book.url}
 ...
 <button className="px-16 py-2 bg-[#F3F2FA] border border-[#2E234B]  text-[#2E234B] transition-all duration-300 hover:bg-[#2E234B] hover:text-[#F3F2FA]">
  ...
  <button className=" px-10 xl:px-16 py-2 bg-[#2E234B] border border-[#2E234B] text-[#F3F2FA] transition-all duration-300 hover:bg-[#F3F2FA] hover:text-[#2E234B]">
    (123) 456-7890
  </button>
        </div>
      </div>
